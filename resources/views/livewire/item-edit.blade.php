        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-2xl font-bold text-gray-700 hover:text-blue-600 md:ms-2">Edit item</span>
                </div>
            </li>
        ...
        <div class="flex ">
            <div class="flex-initial w-6/12  me-10">
                <div class="mb-6">
                    ...
                    <input type="text" id="first_name" wire:model="item_name"
                ...
                <div class="mb-6">
                    <label for="category_name" class="block mb-2 text-lg font-medium text-gray-900">Category
                        name<span class="text-red-700">*</span></label>
                    <select id="category_name" wire:model="category_id"
                        class="bg-gray-50 border border-gray-400 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="mb-6">
                    <div wire:ignore>
                        <label for="description" class="block mb-2 text-lg font-medium text-gray-900">Description<span
                                class="text-red-700">*</span></label>
                        <div id="editor" wire:model="description">{!! $description !!}</div>
                    </div>
                ...
                <div class="mb-6">
                    <label for="item_condition" class="block mb-2 text-lg font-medium text-gray-900">Item
                        condition</label>
                    <select id="item_condition" wire:model="item_condition"
                        class="bg-gray-50 border border-gray-400 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected>Choose a category</option>
                        @foreach (config('enum.item_condition') as $key => $value)
                        <option value="{{ $key }}" {{ $key == $item_condition ? 'selected' : ''}}>{{ $value }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <select id="item_type" wire:model="item_type"
                        class="bg-gray-50 border border-gray-400 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected>Choose a category</option>
                        @foreach (config('enum.item_type') as $key => $value)
                        <option value="{{ $key }}" {{ $key == $item_type ? 'selected' : ''}}>{{ $value }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input {{ $status === 1 ? "checked" : ""}} id="default-checkbox" type="checkbox" value="" wire:model="status"
                ...
                <div class="mb-6">
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        @if($itemImg && $media = $itemImg->getMedia()->last())
                        <img src="{{ $media->getUrl() }}" alt="{{ $media->alt_text }}" width="200px" height="100px" />
                        @else
                        <span>No Image</span>
                        @endif
                    </td>
                    ...
                    <input
                        class="bg-gray-50 border border-gray-400 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        id="file_input" type="file" wire:model="photo">
            ...
            <div class="flex-initial w-6/12 ">
                ...
                <div class="mb-6" wire:ignore>
                    ...
                    <input type="tel" placeholder="" id="phone" wire:model="contact"
                        class="bg-gray-50 border border-gray-400 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                <div class="mb-6">
                    <label for="address" class="block mb-2 text-lg font-medium text-gray-900">Address</label>
                    <textarea wire:model="address" id="address" name="address"
                        class="bg-gray-50 border border-gray-400 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:focus:ring-blue-500 dark:focus:border-blue-500"
